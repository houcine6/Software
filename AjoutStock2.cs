            ...
            else
            {
                try
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        SqlCommand command = new SqlCommand("INSERT INTO stockV4 (Nom, Quantité, [Prix d'achat], [Prix de vente], Montant, Unité) VALUES (@Nom, @Quantité, @PrixAchat, @PrixVente, @Montant, @Unite); SELECT SCOPE_IDENTITY();", connection);
