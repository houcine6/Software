    ...
    public partial class ModifierStock : MaterialForm
    {
        ...
        private void ModifierStock_Load(object sender, EventArgs e)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                string unite = row["Unité"].ToString();
        ...
        private void materialButton3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string unite = materialComboBox1.Text;
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        SqlCommand command = new SqlCommand("UPDATE stockV4 SET Nom=@Nom, Quantité=@Quantité, [Prix d'achat]=@PrixAchat, [Prix de vente]=@PrixVente, Montant=@Montant, Unité=@Unite WHERE Id=" + _id, connection);
                        ...
                        command.Parameters.Add("@Unite", SqlDbType.NVarChar, 50).Value = unite;
